...
msg "   2. Update ${CYAN}CHANGELOG.md${NOFORMAT}"
...
msg ""
msg "${GREEN}Done.${NOFORMAT} Watch the release workflow at https://github.com/model-graph-tools/claude-plugin/actions/workflows/release.yml"
